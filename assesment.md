...
- Add all files to GitHub repo and add REDACTED (<REDACTED FROM AI>) or <REDACTED FROM AI> to organization and project.
...
Please inform me that you finished the assignment by mailing to <REDACTED FROM AI>
